...
class BankTransferPaymentController extends Controller
{
    ...
    public function invoiceAction($id)
    {
        ...
        $hospital_payment_setting = Utility::getHospitalPaymentSetting($user_id);


        return view('invoice.action', compact('invoiceBankTransfer','hospital_payment_setting','invoice'));
    }
