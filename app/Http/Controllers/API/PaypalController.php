...
//    private   $_api_context;
    ...
    public function hospitalPaymentConfig()
    {

            $payment_setting = Utility::getHospitalPaymentSetting(!empty($this->invoiceData)?$this->invoiceData->created_by:0);
